...
/**
 * License validation for Etechflow_Blog.
 *
...
class LicenseValidator
{
    ...
    public const XML_PATH_LICENSE_KEY            = 'etechflow_blog/license/license_key';
    public const XML_PATH_ISSUED_KEY             = 'etechflow_blog/license/issued_key';
    public const XML_PATH_ISSUED_AT              = 'etechflow_blog/license/issued_at';
    public const XML_PATH_IP_BLOCKED             = 'etechflow_blog/license/ip_blocked';
    public const XML_PATH_PORTAL_URL             = 'etechflow_blog/license/portal_url';
    public const XML_PATH_PRODUCTION_ENVIRONMENT = 'etechflow_blog/license/production_environment';
    ...
    private const CACHE_TAG    = 'ETECHFLOW_BLOG';
    private const CACHE_PREFIX = 'etf_blog_lic_';

    // ── HMAC — per-module (UNIQUE to blog; do not reuse elsewhere) ────────────
    private const MODULE_ID = 'blog';
    ...
    private function portalResult(string $host, string $key): array
    {
        ...
        try {
            ...
            $this->curl->addHeader('User-Agent', 'ETechFlow-Blog/1.0');
            $this->curl->get($url);
